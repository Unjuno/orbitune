...
test('service worker precaches decoding, DAW monitor and sampled playback shell', async () => {
  const source = await readFile(new URL('./sw.js', import.meta.url), 'utf8');
  assert.ok(source.includes("orbitune-shell-v7"));
  for (const asset of [
    './', './index.html', './compound.html', './compound-app.mjs', './compound-decoding-runtime.mjs',
    './decoding-presets.mjs', './compound-event-monitor.mjs', './event-monitor.css', './daw-monitor.css',
    './compound-stream.mjs', './compound-soundfont-player.mjs', './vendor/spessasynth-bundle.mjs',
    './vendor/spessasynth_processor.min.js', './soundfont-release.json', './model-cache.mjs',
    './orbitune-192.png', './orbitune-512.png',
