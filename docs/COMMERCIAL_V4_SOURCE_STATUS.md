...
**Status: GREEN / INTEGRATE, LOW-WEIGHT SUPPLEMENT**

- Upstream: `omarperacha/js-fakes`, pin commit `68b476d5b265e579d87c74a68f2160f26007fa56` unless a later reviewed immutable pin is deliberately selected.
- License: repository `LICENSE` is CC BY 4.0.
- Content is algorithmically generated by the KS_Chorus system rather than copied performances/compositions.
- Corpus size is small: 500 annotated generated chorales plus 700 JSF-Extended generated chorales.
- Treat as a low-weight synthetic supplement/regularizer, not as a substitute for real composition diversity.
