...
Native Compound Web ABI V2          validated in local export work
...
Current LoRA Web strategy            pre-merged variant after exact-Base validation
Long-run Base continuation          separate model-training work
```
